    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Manajemen Konselor</h6>
            </div>
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <!-- Tombol Tambah User -->
                    <a href="{{ route('manajemen.konselor.create') }}" class="btn btn-primary mb-2">
                        Tambah Konselor
                    </a>
                </div>        
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <a href="{{ route('manajemen.konselor.edit', $user->id) }}" class="btn btn-info btn-sm mr-1"><i class="bi bi-pencil-square"></i></a>
                                        <form action="{{ route('manajemen.konselor.destroy', $user->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
