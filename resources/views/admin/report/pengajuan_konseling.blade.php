<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Data Form Pengajuan Konseling</h1>
</div>

@if (Auth::user()->role_id == 1)
    <div class="card shadow mb-4">
        <div class="card-body">
            @if ($form_pengajuan_konseling->every(fn($form) => $form->status == 1))
            ...
            @else
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover table-sm text-center" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($form_pengajuan_konseling as $form)
                            @if ($form->status == 0)
                            <tr>
                                <td>{{ $form->doctor->name }}</td>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            @if ($form_pengajuan_konseling->every(fn($form) => $form->status == 0))
...
<div class="card shadow mb-4">
        <div class="card-body">
            @if ($form_pengajuan_konseling->every(fn($form) => $form->user_id != Auth::user()->id))
