            ...
            <div class="card-body">
                <form action="{{ route('manajemen.advokat.update', $id->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="Masukkan Deskripsi" value="{{ $id->deskripsi }}">
                    </div>
                    <div class="form-group">
                        <label for="title">Title</label>
                        <input type="text" class="form-control" id="title" name="title" placeholder="Masukkan Title" value="{{ $id->advocat->title }}" required>
                    </div>
                    <div class="form-group">
